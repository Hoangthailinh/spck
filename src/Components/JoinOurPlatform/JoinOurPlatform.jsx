    ...
    <div className="join-platform-container">
      ...
      <div className="">
        <p className="join-description">
          You can be one of the <span className="highlight-member">members</span> of our platform by just adding some necessarily information. If you already have an account on our website, you can just hit the <a href="/login" className="highlight-login">Login button</a>.
        </p>
